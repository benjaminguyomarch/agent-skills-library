...
metadata:
  ...
  version: "1.0"
  source: Projets/morgane/site (pipeline complet dans docs/agents/)
---
...
Suivre les étapes dans l'ordre. La référence détaillée de chaque étape est dans `Documents/Projets/morgane/site/docs/agents/` (fichiers `00-setup.md` → `10-review-monitor.md`) — les lire avant d'exécuter l'étape correspondante.
